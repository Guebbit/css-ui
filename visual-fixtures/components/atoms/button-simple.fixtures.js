export const simpleButtonScenarios = [
    {
        ...
        markup: `
            <div class="fixture-stack">
                ...
                <div class="simple-button disabled" aria-disabled="true">DISABLED</div>
            </div>
        `,
    },
    {
        ...
        markup: `
            <div class="fixture-stack">
                ...
                <div class="simple-button button-outlined disabled" aria-disabled="true">OUTLINED DISABLED</div>
            </div>
        `,
    },
    {
        ...
        markup: `
            <div class="fixture-stack">
                ...
                <div class="simple-button button-plain disabled" aria-disabled="true">PLAIN DISABLED</div>
            </div>
        `,
    },
    {
