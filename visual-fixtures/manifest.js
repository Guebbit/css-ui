...
export const visualManifest = {
    ...
    components: [
        ...
        },
        {
            ...
            scenarios: docsDerived.buttonCyberpunkScenarios,
        },
        {
        ...
        },
        {
            ...
            scenarios: docsDerived.cardCalendarScenarios,
        },
        {
            componentId: "list",
        ...
        {
            componentId: "typography-special-title",
            status: "draft",
            parityMode: "draft",
            ...
            scenarios: docsDerived.typographySpecialTitleScenarios,
        },
        {
            componentId: "typography-svg-title",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "atoms/typography",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.typographySvgTitleScenarios,
        },
        {
            componentId: "text",
            status: "missing-equivalent",
        ...
        {
            componentId: "highlight-corner-ribbon",
            status: "draft",
            parityMode: "draft",
            ...
            scenarios: docsDerived.highlightCornerRibbonScenarios,
        },
        {
        ...
        {
            componentId: "panel-simple-typography",
            status: "missing-equivalent",
            parityMode: "inventory-only",
            fixtureGroup: "molecules/panels",
            defaultMaxDiffRatio: 0.08,
            ...
            notes: "Documented in v2 but not shipped as a standalone component stylesheet in css-ui 1.3.",
            scenarios: docsDerived.panelSimpleTypographyScenarios,
        },
        {
            componentId: "progress-circular-css",
            status: "draft",
            parityMode: "draft",
            ...
            scenarios: docsDerived.progressCircularCssScenarios,
        },
        {
            componentId: "progress-circular-svg",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "molecules/progress",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.progressCircularSvgScenarios,
        },
        {
            componentId: "button-expressive",
            status: "draft",
            parityMode: "draft",
            ...
            scenarios: docsDerived.buttonExpressiveScenarios,
        },
        {
            componentId: "button-icon-focus",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "molecules/buttons",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.buttonIconFocusScenarios,
        },
        {
            componentId: "button-neon",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "molecules/buttons",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.buttonNeonScenarios,
        },
        {
            componentId: "card-book",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "atoms/cards",
            defaultMaxDiffRatio: 0.08,
            styleImports: {
                ...
                v2: "../src/components/atoms/card-book/index.scss",
            },
            scenarios: docsDerived.cardBookScenarios,
        },
        {
            componentId: "card-countdown",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "atoms/cards",
            defaultMaxDiffRatio: 0.08,
            styleImports: {
                ...
                v2: "../src/components/atoms/card-countdown/index.scss",
            },
            scenarios: docsDerived.cardCountdownScenarios,
        },
        {
            componentId: "card-credit",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "atoms/cards",
            defaultMaxDiffRatio: 0.08,
            styleImports: {
                ...
                v2: "../src/components/atoms/card-credit/index.scss",
            },
        ...
        },
        {
            ...
            styleImports: {
                ...
                v2: "../src/components/atoms/card/index.scss",
            },
            scenarios: docsDerived.cardScenarios,
        },
        {
            componentId: "card-image-hover",
            status: "missing-equivalent",
            parityMode: "inventory-only",
            fixtureGroup: "atoms/cards",
            defaultMaxDiffRatio: 0.08,
            styleImports: {
                v1: null,
                v2: "../src/components/atoms/card-image-hover/index.scss",
            },
            notes: "Documented in v2 but not shipped as a standalone component stylesheet in css-ui 1.3.",
            scenarios: docsDerived.cardImageHoverScenarios,
        },
        {
            componentId: "panel-action",
            status: "blocked-oracle",
            parityMode: "inventory-only",
            fixtureGroup: "molecules/panels",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.panelActionScenarios,
        },
        {
            componentId: "list-opening-hours",
            status: "blocked-oracle",
            parityMode: "inventory-only",
            fixtureGroup: "molecules/lists",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.listOpeningHoursScenarios,
        },
        {
            componentId: "card-choose-option",
            status: "blocked-oracle",
            parityMode: "inventory-only",
            ...
            scenarios: docsDerived.cardChooseOptionScenarios,
        },
        {
            componentId: "card-event-lite",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "organisms/cards",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.cardEventLiteScenarios,
        },
        {
            componentId: "card-event-long",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "organisms/cards",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.cardEventLongScenarios,
        },
        {
            componentId: "card-event-minimal",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "organisms/cards",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.cardEventMinimalScenarios,
        },
        {
            componentId: "card-image-slash",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "organisms/cards",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.cardImageSlashScenarios,
        },
        {
            componentId: "card-info-hover",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "organisms/cards",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.cardInfoHoverScenarios,
        },
        {
            componentId: "card-overflow",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "organisms/cards",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.cardOverflowScenarios,
        },
        {
            componentId: "card-pricing",
            status: "draft",
            parityMode: "draft",
            fixtureGroup: "organisms/cards",
            defaultMaxDiffRatio: 0.08,
            ...
            scenarios: docsDerived.cardPricingScenarios,
        },
        {
            componentId: "panel-timeline-tree",
            status: "draft",
            parityMode: "draft",
            ...
            scenarios: docsDerived.panelTimelineTreeScenarios,
        },
        {
