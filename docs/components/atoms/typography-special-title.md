...
::: raw
<!--@include: ../../examples/atoms/typography-special-title-default.html -->
:::

::: code-group
```html [characters]
<h2 class="typography-special-title use-brand">
...
<h2 class="typography-special-title title-with-line use-brand">
...
```
```html [shadow]
<h2 class="typography-special-title title-with-shadow use-brand">Shadow</h2>
```
```html [strong-shadow]
<h2 class="typography-special-title title-with-strong-shadow use-brand">Strong Shadow</h2>
```
```html [text-appear]
<h2 class="typography-special-title animate-on-hover use-brand">
...
::: raw
<!--@include: ../../examples/atoms/typography-special-title-lines.html -->
:::

::: code-group
```html [line]
<h2 class="typography-special-title title-with-line use-brand">Line</h2>
```
```html [full-line]
<h2 class="typography-special-title title-with-full-line use-brand">Full Line</h2>
```
```html [strong-shadow-line]
<h2 class="typography-special-title title-with-full-line title-with-strong-shadow use-brand" >Full Shadow Line</h2>
```
```html [line-border]
<h2 class="typography-special-title title-with-line-border use-brand"><span>Line as Border</span></h2>
```
```html [line-border-shadow]
<h2 class="typography-special-title title-with-full-line title-with-strong-shadow title-with-line-border use-brand"><span>Line + Border + Shadow</span></h2>
```
:::
...
::: raw
<!--@include: ../../examples/atoms/typography-special-title-custom.html -->
:::

::: code-group
```html [html]
<h2 class="typography-special-title title-with-line-border title-with-strong-shadow custom-css use-brand">Custom CSS</h2>
```
``` css [css]
.typography-special-title {
  &.custom-css{
