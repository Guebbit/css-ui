...
```scss
@use "@guebbit/css-ui/molecules/panel";
```
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-basic-2.html -->
:::

```html
<div class="panel use-brand" style="height: 500px">
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-with-overlay.html -->
:::
...
```
```html [class]
<div class="panel panel-overlay use-brand" style="height: 500px">
    <img class="panel-background" src="https://placedog.net/1000/1000" alt="" title="">
    <div class="panel-content">
        <div class="content-example">Regular</div>
    </div>
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-basic.html -->
:::
...
<div class="panel centered-mode" style="height: 500px">
    <div class="panel-overlay"></div>
    <img class="panel-background" src="https://placedog.net/1000/1000" alt="" title="">
    <div class="panel-content">
        <div class="content-example">Regular</div>
...
<div class="panel bottom-mode" style="height: 500px">
    <div class="panel-overlay"></div>
    <img class="panel-background" src="https://placedog.net/1000/1000" alt="" title="">
    <div class="panel-content">
        <div class="content-example">Regular</div>
...
<div class="panel content-size-mode">
    <div class="panel-overlay"></div>
    <img class="panel-background" src="https://placedog.net/1000/1000" alt="" title="">
    <div class="panel-content">
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-background.html -->
:::
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-color.html -->
:::
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-video.html -->
:::
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-iframe-2.html -->
:::
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-iframe.html -->
:::

```html {3}
<div 
    class="panel content-size-mode" 
...
::: raw
<!--@include: ../../examples/molecules/panels/Panel-custom-multiple-backgrounds-and-linear-gradient-shadow.html -->
:::

```html
<div class="panel use-brand" style="height: 500px; --overlay: linear-gradient(0.25turn, #3f87a6, #ebf8e1, #f69d3c)">
    <div class="panel-overlay"></div>
...
::: code-group
<<< @/../src/components/molecules/panel/_architecture.scss [_architecture.scss]
<<< @/../src/components/molecules/panel/index.scss [index.scss]
:::
...
@use "../src/components/molecules/panel";
...
| :--------------|:-------------|:-------------|:-----------------|:---------|
| `$duration` | `--panel-duration` | Transitions duration | `time` | `0.3s` |
...
| `$overlay-opacity` | `--panel-overlay-opacity` | Overlay opacity | `percentage` | `0.75` |
