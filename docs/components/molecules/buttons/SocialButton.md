...
- [ButtonLargeIcon](/components/atoms/buttons/ButtonLargeIcon)
:::
...
## Regular (same as [SimpleButton](/components/atoms/buttons/SimpleButton))
...
## Brand Icon (same as [ButtonLargeIcon](/components/atoms/buttons/ButtonLargeIcon))
...
Uses the documented classes from [SimpleButton](/components/atoms/buttons/SimpleButton) and [ButtonLargeIcon](/components/atoms/buttons/ButtonLargeIcon), plus the brand utility classes generated by `theme.create-colors(...)`.

## SCSS variables

No social-button-specific SCSS variables. Use the variables documented in [SimpleButton](/components/atoms/buttons/SimpleButton) and [ButtonLargeIcon](/components/atoms/buttons/ButtonLargeIcon).
