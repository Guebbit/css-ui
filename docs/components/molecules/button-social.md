...
Uses the documented classes from [SimpleButton](/components/atoms/button-simple), [HighlightPopup](/components/atoms/highlight-popup), and [HighlightRollup](/components/atoms/highlight-rollup), plus the brand utility classes generated by `theme.create-colors(...)`.

## SCSS variables

No social-button-specific SCSS variables. Use the variables documented in [SimpleButton](/components/atoms/button-simple), [HighlightPopup](/components/atoms/highlight-popup), and [HighlightRollup](/components/atoms/highlight-rollup).
