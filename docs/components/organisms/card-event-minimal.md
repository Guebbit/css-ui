...
::: raw
<!--@include: ../../examples/organisms/card-event-minimal-default.html -->
:::

::: code-group
```html [Default]
<div class="card-event-minimal animate-on-hover use-brand">
    ...
    <div class="button button-pill animate-on-hover core-white-color core-orange-bg">
...
```
```html [With border]
<div class="card-event-minimal border-on-hover animate-on-hover use-brand">
    SAME AS [Default]
</div>
```
:::
