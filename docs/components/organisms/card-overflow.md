...
::: tip INCLUDED
- [ExpressiveButton](/components/molecules/button-expressive)
- [HighlightLine](/components/atoms/highlight-line)
:::
...
<!--@include: ../../examples/organisms/card-overflow-default.html -->
</div>
:::
...
::: code-group
<<< @/../src/components/organisms/card-overflow/_architecture.scss [_architecture.scss]
<<< @/../src/components/organisms/card-overflow/index.scss [index.scss]
:::
...
<style lang="scss">
@use "../src/components/organisms/card-overflow";
</style>
