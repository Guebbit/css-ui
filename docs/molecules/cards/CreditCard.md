...
<div class="dev-section">
    <div class="credit-card">
       <div class="credit-card-true">
          <div class="front">
                     <svg class="credit-card-logo" style="fill: blue" viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10" />
                </svg>
             <svg version="1.1" class="credit-card-front" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" xml:space="preserve">
                <g id="Front">
          ...
          <div class="back">
             <svg version="1.1" class="credit-card-back" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" xml:space="preserve">
                <g id="Front">
...
```html
<div class="credit-card" style="--credit-card-text-color:#000000; --credit-card-bg-color:#ffff33;">
    <div class="credit-card-true">
        <div class="front">
            <img class="credit-card-logo" src="http://localhost:8080/logo.svg">
            <svg version="1.1" class="credit-card-front" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" xml:space="preserve">
            <g id="Front">
               <g id="credit-card-background">
                  <g id="Page-1_1_">
