        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Generic Simple Chip', link: '/components/atoms/generic-simple-chip' },
                    ...
                    { text: 'Input Simple', link: '/components/atoms/input-simple' },
                    ...
                    { text: 'Typography Simple Text Icon', link: '/components/atoms/typography-simple-text-icon' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Card Simple', link: '/components/molecules/card-simple' },
                    ...
                    { text: 'List Simple', link: '/components/molecules/list-simple' },
                    { text: 'Panel Action', link: '/components/molecules/panel-action' },
                    { text: 'Panel Simple', link: '/components/molecules/panel-simple' },
