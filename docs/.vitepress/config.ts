        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Card', link: '/components/atoms/card' },
                    { text: 'Card Book', link: '/components/atoms/card-book' },
                    { text: 'Card Calendar', link: '/components/atoms/card-calendar' },
                    { text: 'Card Countdown', link: '/components/atoms/card-countdown' },
                    { text: 'Card Credit', link: '/components/atoms/card-credit' },
                    { text: 'Card Image Hover', link: '/components/atoms/card-image-hover' },
