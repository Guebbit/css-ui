...
const __pageData = JSON.parse(`{"title":"Alex Warnes's Rotating Squares","description":"","frontmatter":{},"headers":[{"level":3,"title":"Codepen","slug":"codepen","link":"#codepen","children":[]},{"level":2,"title":"Code","slug":"code","link":"#code","children":[]},{"level":2,"title":"SCSS variables","slug":"scss-variables","link":"#scss-variables","children":[]},{"level":2,"title":"Authors","slug":"authors","link":"#authors","children":[]}],"relativePath":"atoms/animations/AlexWarnesRotatingSquares.md"}`);
...
const _sfc_main = Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="alex-warnes-s-rotating-squares" tabindex="-1">Alex Warnes&#39;s Rotating Squares <a class="header-anchor" href="#alex-warnes-s-rotating-squares" aria-hidden="true">#</a></h1>`);
      ...
      _push(`<h3 id="codepen" tabindex="-1"><a href="https://codepen.io/AlexWarnes/pen/jXYYKL" target="_blank" rel="noreferrer">Codepen</a> <a class="header-anchor" href="#codepen" aria-hidden="true">#</a></h3><h2 id="code" tabindex="-1">Code <a class="header-anchor" href="#code" aria-hidden="true">#</a></h2><div class="dev-section"><div class="alex-warnes-progressions rotating-squares"><div></div><div></div></div></div><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-OGIMY" id="tab-B26BGuk" checked="checked"><label for="tab-B26BGuk">AlexWarnesRotatingSquares.html</label><input type="radio" name="group-OGIMY" id="tab-HfbPgxW"><label for="tab-HfbPgxW">AlexWarnesRotatingSquares.scss</label></div><div class="blocks"><div class="language-html active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&lt;</span><span style="${ssrRenderStyle({ "color": "#F07178" })}">div</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}"> </span><span style="${ssrRenderStyle({ "color": "#C792EA" })}">class</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">=</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&quot;</span><span style="${ssrRenderStyle({ "color": "#C3E88D" })}">alex-warnes-progressions rotating-squares</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&quot;</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&gt;</span></span>
