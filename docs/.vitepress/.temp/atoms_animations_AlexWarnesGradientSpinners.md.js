...
const __pageData = JSON.parse(`{"title":"Alex Warnes's Gradient Spinners","description":"","frontmatter":{},"headers":[],"relativePath":"atoms/animations/AlexWarnesGradientSpinners.md"}`);
...
const _sfc_main = Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="alex-warnes-s-gradient-spinners" tabindex="-1">Alex Warnes&#39;s Gradient Spinners <a class="header-anchor" href="#alex-warnes-s-gradient-spinners" aria-label="Permalink to &quot;Alex Warnes&#39;s Gradient Spinners&quot;">​</a></h1>`);
      ...
      _push(`<h3 id="codepen" tabindex="-1"><a href="https://codepen.io/AlexWarnes/pen/jXYYKL" target="_blank" rel="noreferrer">Codepen</a> <a class="header-anchor" href="#codepen" aria-label="Permalink to &quot;[Codepen](https://codepen.io/AlexWarnes/pen/jXYYKL)&quot;">​</a></h3><h2 id="code" tabindex="-1">Code <a class="header-anchor" href="#code" aria-label="Permalink to &quot;Code&quot;">​</a></h2><div class="dev-section"><div class="alex-warnes-progressions gradient-spinner"><div></div></div></div><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-8iTa2" id="tab-2scP8p_" checked="checked"><label for="tab-2scP8p_">AlexWarnesGradientSpinners.html</label><input type="radio" name="group-8iTa2" id="tab-8mRtGWu"><label for="tab-8mRtGWu">AlexWarnesGradientSpinners.scss</label></div><div class="blocks"><div class="language-html active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&lt;</span><span style="${ssrRenderStyle({ "color": "#F07178" })}">div</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}"> </span><span style="${ssrRenderStyle({ "color": "#C792EA" })}">class</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">=</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&quot;</span><span style="${ssrRenderStyle({ "color": "#C3E88D" })}">alex-warnes-progressions gradient-spinner</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&quot;</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&gt;</span></span>
...
<span class="line"><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}">    </span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">}</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">}</span></span></code></pre></div></div></div><h2 id="scss-variables" tabindex="-1">SCSS variables <a class="header-anchor" href="#scss-variables" aria-label="Permalink to &quot;SCSS variables&quot;">​</a></h2><table><thead><tr><th style="${ssrRenderStyle({ "text-align": "left" })}">Variable</th><th style="${ssrRenderStyle({ "text-align": "left" })}">Description</th><th style="${ssrRenderStyle({ "text-align": "left" })}">Accepted Values</th><th style="${ssrRenderStyle({ "text-align": "left" })}">Default</th></tr></thead><tbody><tr><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>$alex-warnes-progressions-size</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}">Main size</td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>size</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>200</code></td></tr><tr><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>$alex-warnes-progressions-border-size</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}">Border size</td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>size</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>5px</code></td></tr><tr><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>$alex-warnes-progressions-secondary</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}">Secondary color</td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>color</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>#fb5b53</code></td></tr><tr><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>$alex-warnes-progressions-background</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}">Background color</td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>color</code></td><td style="${ssrRenderStyle({ "text-align": "left" })}"><code>#1d2630</code></td></tr></tbody></table><h2 id="authors" tabindex="-1">Authors <a class="header-anchor" href="#authors" aria-label="Permalink to &quot;Authors&quot;">​</a></h2>`);
