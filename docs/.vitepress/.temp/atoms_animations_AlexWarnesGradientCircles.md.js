...
const __pageData = JSON.parse(`{"title":"Alex Warnes's Gradient Circles","description":"","frontmatter":{},"headers":[],"relativePath":"atoms/animations/AlexWarnesGradientCircles.md"}`);
...
const _sfc_main = Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="alex-warnes-s-gradient-circles" tabindex="-1">Alex Warnes&#39;s Gradient Circles <a class="header-anchor" href="#alex-warnes-s-gradient-circles" aria-label="Permalink to &quot;Alex Warnes&#39;s Gradient Circles&quot;">​</a></h1>`);
      ...
      _push(`<h3 id="codepen" tabindex="-1"><a href="https://codepen.io/AlexWarnes/pen/jXYYKL" target="_blank" rel="noreferrer">Codepen</a> <a class="header-anchor" href="#codepen" aria-label="Permalink to &quot;[Codepen](https://codepen.io/AlexWarnes/pen/jXYYKL)&quot;">​</a></h3><h2 id="code" tabindex="-1">Code <a class="header-anchor" href="#code" aria-label="Permalink to &quot;Code&quot;">​</a></h2><div class="dev-section"><div class="alex-warnes-progressions gradient-circles"><div></div><div></div></div></div><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-1Qfh-" id="tab-f1Xabyx" checked="checked"><label for="tab-f1Xabyx">AlexWarnesGradientCircles.html</label><input type="radio" name="group-1Qfh-" id="tab-rP-5WZF"><label for="tab-rP-5WZF">AlexWarnesGradientCircles.scss</label></div><div class="blocks"><div class="language-html active"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&lt;</span><span style="${ssrRenderStyle({ "color": "#F07178" })}">div</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}"> </span><span style="${ssrRenderStyle({ "color": "#C792EA" })}">class</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">=</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&quot;</span><span style="${ssrRenderStyle({ "color": "#C3E88D" })}">alex-warnes-progressions gradient-circles</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&quot;</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}">&gt;</span></span>
