...
::: raw
<!--@include: ../examples/atoms/animation-shape-slash-container-default.html -->
:::
...
::: code-group
<<< @/../src/components/atoms/animation-shape-slash-container/_architecture.scss [_architecture.scss]
<<< @/../src/components/atoms/animation-shape-slash-container/index.scss [index.scss]
:::
...
<style lang="scss">
@use "../src/components/atoms/animation-shape-slash-container";
