...
@use "@guebbit/css-ui/src/atoms/typography/specia\1-\2itle/index" with (
...
<<< @/../src/atoms/typography/specia\1-\2itle/index.scss
...
@use "../src/atoms/typography/specia\1-\2itle/index" with (
    $css-ui-root-prefix: theme.$css-ui-root-prefix,
    $adjust: -0.1em,
    $border-style: dashed,
);
